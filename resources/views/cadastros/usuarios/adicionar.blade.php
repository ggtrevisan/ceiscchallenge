                    ...
                    <form id="formCadastro">
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-md-6">
                                ...
                                {!!Form::text('name', '', array('class' => 'form-control', 'placeholder' => 'Digite o nome'));!!}
                            </div>   
                            <div class="col-xs-12 col-sm-6 col-md-6">
                                {!!Form::label('descricao', 'E-mail'); !!}
                                {!!Form::email('email', '', array('class' => 'form-control', 'placeholder' => 'Digite o e-mail'));!!}
                            </div> 
                            <div class="col-xs-12 col-sm-6 col-md-6">
                                {!!Form::label('descricao', 'Senha'); !!}
                                <input id="password" type="password" class="form-control" placeholder="Digite a senha" name="password" required>
                            </div>     
                        </div> 
